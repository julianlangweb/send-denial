...
class Options
{
    ...
    public function load_options() {
        ...
        $GLOBALS['sede_error_message'] = __( 'An error occured, you have no javascript, this websites has a problem or you are a spammer', SEDE_TEXTDOMAIN );
    }
    ...
    public function register_settings() {
        ...
        add_settings_section( 
            'general_section', 
            __( 'Settings', SEDE_TEXTDOMAIN ), 
            array(), 
            'sede_plugin' 
        );
        add_settings_section( 
            'credits_section', 
            __( 'Credits', SEDE_TEXTDOMAIN ), 
        ...
        add_settings_field( 
            'sede_field_name', 
            __( 'Honeypot Field Name', SEDE_TEXTDOMAIN ), 
        ...
        add_settings_field( 
            'sede_field_value', 
            __( 'Honeypot Field Value', SEDE_TEXTDOMAIN ), 
    ...
    public function add_settings_page() {
        add_options_page( 
            __( 'Send Denial Anti Spam Settings', SEDE_TEXTDOMAIN ), 
            'Send Denial', 
            'manage_options', 
            'send-denial', 
    ...
    public function render_plugin_settings_page() {
        ?>
        <h2><?= __( 'Send Denial', SEDE_TEXTDOMAIN ) ?></h2>
        <form action="options.php" method="POST">
            <?php 
            settings_fields( 'sede_plugin_options' );
            do_settings_sections( 'sede_plugin' ); ?>
            <input name="submit" class="button button-primary button-hero" type="submit" value="<?= __( 'Save Changes', SEDE_TEXTDOMAIN ) ?>" />
        </form>
        <?php
    }
    ...
    public function plugin_setting_show_credits() {
        ...
        $html = "<input id='sede_setting_show_credits' name='sede_plugin_options[show_credits]' type='checkbox' value='1' ".checked( 1, $value, false )."/>";
        echo $html;
    }
